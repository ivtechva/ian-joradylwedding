 ...
 const EntourageSection = () => {
   const entourage = {
     "Principal Sponsors": [
        "Roque L. Maravillas & Maria Alma A. Maravillas",
        "Rommel L. Cruz & Norena P. Cruz",
      ],
    ...
    "Bridesmaids": [
      "Maid of Honor: Frenzescka Maravillas",
      "Fabrienne L. Candia",
      "Aren Mae L. Candia",
      "Sheena T. Mae Gracilla",
      "Trisha",
    ],
    "Flower Girl": ["Friane Paula C. Mendoza"],
